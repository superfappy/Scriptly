// ==UserScript==
// @name         Modify Submission Testing
// @namespace    https://eservices.mohre.gov.ae/
// @version      1.4
// @description  Intercepts requests to /TasheelWeb/services/transactionentry/10, modifies response validations, and processes RedirectUrl.
// @author       Scriptly
// @match        https://eservices.mohre.gov.ae/TasheelWeb/*
// @grant        none
// @updateURL    https://raw.githubusercontent.com/superfappy/Scriptly/main/Modify-Submission-MOHRE.user.js
// @downloadURL  https://raw.githubusercontent.com/superfappy/Scriptly/main/Modify-Submission-MOHRE.user.js
// ==/UserScript==
        ...
        this.addEventListener("readystatechange", function() {
            if (!scriptExecuted && this.readyState === 4) {
                try {
                    ...
                    if (url.includes('/TasheelWeb/services/transactionentry/10')) {
                        if (jsonResponse) {
